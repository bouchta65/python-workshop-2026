...
Écrivez un programme Python qui évalue l'éligibilité pour un prêt en fonction de :
...
Écrivez un programme Python pour calculer la prime d'assurance d'une voiture en fonction de :
...
Écrivez un programme Python pour déterminer les jours de congé restant en fonction de :
...
Écrivez un programme Python pour évaluer la performance d'un employé en fonction de :
...
Écrivez un programme Python pour planifier un voyage en fonction de :
- Budget (en euros)
...
Écrivez un programme Python pour calculer la facture d'électricité en fonction de :
...
Écrivez un programme Python pour calculer les impôts à payer en fonction de :
- Revenu annuel (en euros)
...
Écrivez un programme Python pour déterminer le plan de santé en fonction de :
- Âge
...
Écrivez un programme Python pour calculer le salaire d'un employé en fonction de :
...
Écrivez un programme Python pour déterminer le plan de retraite en fonction de :
- Âge
