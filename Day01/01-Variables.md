...
Écrivez un programme en Python qui va permettre d'afficher vos informations personnelles : nom, prénom, âge, sexe, et adresse email. Les données sont saisies à partir du clavier.
...
Écrivez un programme en Python pour calculer la moyenne pondérée de trois nombres donnés par l'utilisateur avec les pondérations suivantes :
...
Écrivez un programme en Python pour trouver la moyenne géométrique de trois nombres saisis par l'utilisateur.
Formule :
```
...
Écrivez un programme Python pour trouver la distance entre deux points donnés dans un espace 3D.
Formule :
```
...
Écrivez un programme Python pour afficher un nombre entier à quatre chiffres dans l'ordre inverse sans utiliser de boucle. Par exemple, si le nombre entier est 1234, son inverse est 4321.
